...
export function ArticleBlock({ articles }) {
    return (
                ...
                <article key={article.id} className="flex flex-col items-start justify-between">
                    ...
                    <div className="mt-6 max-w-xl">
                        <div className="flex items-center justify-between gap-x-4 text-xs">
                            <time dateTime={article.published_at} className="text-muted-foreground">
                        ...
                        <div className="group relative">
                            <h3 className="mt-3 line-clamp-1 text-lg font-semibold leading-6 text-muted-foreground group-hover:text-foreground">
