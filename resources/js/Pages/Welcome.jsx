                ...
                <div className="p-6 text-right sm:fixed sm:right-0 sm:top-0">
                    {auth.user ? (
                        <Link
                            ...
                            className="font-semibold text-gray-400 hover:text-gray-900 focus:rounded-sm focus:outline focus:outline-2 focus:outline-red-500 dark:text-gray-400 dark:hover:text-white"
                        >
                            Dashboard
                        </Link>
                    ) : (
                        <>
                            ...
                            <Link
                                href={route('register')}
                                className="ml-4 font-semibold text-gray-400 hover:text-gray-900 focus:rounded-sm focus:outline focus:outline-2 focus:outline-red-500 dark:text-gray-400 dark:hover:text-white"
                            >
                                Register
                            </Link>
                        </>
