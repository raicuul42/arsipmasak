                        ...
                        <div className="p-4">
                            <div className="flex items-start">
                                <div className="flex-shrink-0">
                                    {flash_message.type === 'success' && <CheckCircleIcon className="h-5 w-5 text-emerald-500 lg:mt-0.5" />}
                                    {flash_message.type === 'error' && <ExclamationCircleIcon className="h-5 w-5 text-rose-500 lg:mt-0.5" />}
                                    {flash_message.type === 'info' && <ExclamationCircleIcon className="h-5 w-5 text-sky-500 lg:mt-0.5" />}
                                    {flash_message.type === 'warning' && <ExclamationCircleIcon className="h-5 w-5 text-orange-500 lg:mt-0.5" />}
                                </div>
